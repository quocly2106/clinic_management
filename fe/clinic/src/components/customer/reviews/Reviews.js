...
import "./Reviews.css";
import { customerReviews } from "./ReviewsList";
  ...
  return (
    <div className="review-section" id="reviews">
      <div className="rw-text-content">
        ...
        Hơn thế nữa <span className="rw-text-num">1500+ Khách hàng</span>
        </p>

        <p className="rw-text-desc">Đừng tin chúng tôi, hãy kiểm tra lời khách hàng</p>
